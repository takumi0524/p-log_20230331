                            ...
                            <div class="flex flex-wrap -m-2">
                              ...
                              {{-- <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <input type="hidden" id="username" name="username" value="{{ $myprofile->username }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                {{-- </div>
                              </div> --}}
                              ...
                              {{-- <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <input type="hidden" id="userid" name="userid" value="{{ $myprofile->userid }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                {{-- </div>
                              </div> --}}
                              ...
                              <div class="p-2 w-full">
                                <div class="relative">
                                  ...
                                  <input type="radio" name="gender" value="1" @if($myprofile->gender == 1) checked @endif>男性                         
                                  <input type="radio" name="gender" value="2" @if($myprofile->gender == 2) checked @endif>女性   
                                  <input type="radio" name="gender" value="3" @if($myprofile->gender == 3) checked @endif>その他         
                                </div>
                              </div>
