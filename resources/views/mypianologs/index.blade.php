            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                  <div class="p-2 w-full flex">
                    <a href="{{ route( 'mypianologs.create') }}" class="text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg" >演奏曲新規登録</a>
                  </div>
                        ...
                        <table class="table-auto w-full text-left whitespace-no-wrap">
                          <thead>
                            <tr>
                              ...
                              <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">演奏時間</th>
                              ...
                              <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tr rounded-br">内容編集</th>
                            </tr>
                          </thead>
                          <tbody>
                          @if (isset($mypianologs))
                            ...
                            <tr>
                              ...
                              <td class="border-t-2 border-gray-200 px-4 py-3"><a  class="text-blue-500" href="{{ route('mypianologs.edit', ['id' => $mypianolog->id ] )}}">編集</a></td>
                            </tr>
                            @endforeach
                            @else
